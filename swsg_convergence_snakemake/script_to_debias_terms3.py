...
# with open("/home/jacob/SWSG_repo/swsg_convergence_snakemake/data_store/four_epsilon_0.003125_profile_perturbedjet_results_nolloyd.pkl", "rb") as f:
...
uotclass = DebiasedUOT(pykeops=True, cuda_device='cuda:3')
...
with open("/home/jjf817/SWSG_repo/swsg_convergence_snakemake/data_store/four_epsilon_0.003125_profile_perturbedjet_debiasing_term0_dual_cost.pkl", "wb") as f:
