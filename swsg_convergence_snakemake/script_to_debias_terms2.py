...
# debiasing term 1
uotclass = DebiasedUOT(pykeops=True, cuda_device='cuda:2')
uotclass.parameters(epsilon=0.01)
uotclass.densities(X, X, h_true, h_true)
...
with open("/home/jjf817/SWSG_repo/swsg_convergence_snakemake/data_store/four_epsilon_0.003125_profile_perturbedjet_debiasing_term2_dual_cost.pkl", "wb") as f:
