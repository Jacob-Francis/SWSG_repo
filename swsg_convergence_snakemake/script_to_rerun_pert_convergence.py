...
for epsilon in epsilons:
    ...
    # X, Y, G, h_true, mu = jet_profile_initialisation(epsilon, strength=0.0001, f=1.0, g=0.1, a=0.1, b=10.0, c=0.5, d=1.0)
    X, Y, G, h_true, mu = jet_profile_initialisation(fine_epsilon, strength=0.0001, f=1.0, g=0.1, a=0.1, b=10.0, c=0.5, d=1.0)
    ...
    uotclass = DebiasedUOT(pykeops=True, cuda_device='cuda:0')
    ...
    uotclass1 = DebiasedUOT(pykeops=True, cuda_device='cuda:0')
...
uotclass2 = DebiasedUOT(pykeops=True, cuda_device='cuda:0')
