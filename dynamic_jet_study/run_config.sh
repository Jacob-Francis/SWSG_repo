...
nohup python3 sim_study.py 3 0.02 0.0001 3 > methodcompare_mid.out 2> methodcompare_mid.err

nohup python3 sim_study.py 7 0.01 0 1 > mid100_0.out 2> mid100_0.err
...
nohup python3 sim_study.py 2 0.0025 0.00005 1 > hifi.out 2> hifi.err
